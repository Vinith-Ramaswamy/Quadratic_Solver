    ...
    def b1 ():#the top button (vertex form)
        ...
        def submit ():  #command for the submit button
            def loop(): #to exit this program and opens the other one
                def end():
                    os.startfile(r"C:\Users\Vinit\PycharmProjects\Vinith\dist\Quadratic_Solver\Quadratic_Solver.exe")
                    info.destroy()
                    sys.exit()
...
# ----------------------ends writting the text for the equation-----------------#
        ...
        def submit ():
            def loop():
                def loop():  # to exit this program and opens the other one
                    def end():
                        os.startfile(
                            r"C:\Users\Vinit\PycharmProjects\Vinith\dist\Quadratic_Solver\Quadratic_Solver.exe")
                        info.destroy()
                        sys.exit()
    ...
    b2 = Button(topframe, text="Information",
    ...
    b1photo=PhotoImage(file=r"C:\Users\Vinit\PycharmProjects\Vinith\dist\Quadratic_Solver\b1.GIF")
    b1photo = b1photo.zoom(10)  # with 250, I ended up running out of memory
    ...
    b2photo = PhotoImage(file=r"C:\Users\Vinit\PycharmProjects\Vinith\dist\Quadratic_Solver\b2.GIF")
    b2photo = b2photo.zoom(10)  # with 250, I ended up running out of memory
